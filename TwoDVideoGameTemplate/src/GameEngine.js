...
//Preloading of resources of this specific game the engine is to run:

//This is the only place (except for the instantiation of the specific game object) that is
...
//Sets up the game screen and behind the scenes attributes:
function setup()
{
